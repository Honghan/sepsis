...
DROP  VIEW IF EXISTS SOFA CASCADE;
CREATE VIEW SOFA AS
with wt AS
(
...
drop TABLE if exists sofa_distinct cascade; 

create TABLE sofa_distinct as
select distinct subject_id, hadm_id, icustay_id, sofa, respiration, coagulation, liver, cardiovascular, cns, renal from sofa; 
