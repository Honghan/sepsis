...
drop materialized view if exists Vitals_SS cascade; 
create materialized view Vitals_SS as
(
select subject_id,
		hadm_id,
	   ...
	   , min(Spontaneous_respiratory_rate_Min) as Spontaneous_respiratory_rate_Min
	   ,max(Spontaneous_respiratory_rate_Max) as Spontaneous_respiratory_rate_Max
